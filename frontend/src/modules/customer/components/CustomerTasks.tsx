...
export default function CustomerTasks({ customerId }: { customerId: string }) {
  const [createOpen, setCreateOpen] = useState(false);
  const { data, isLoading } = useTasks(1, { customerId }, 100);
      ...
      <div className="flex items-center justify-between">
        ...
        <Dialog open={createOpen} onOpenChange={setCreateOpen}>
          ...
          <DialogContent>
            ...
            <TaskForm customerId={customerId} onSuccess={() => setCreateOpen(false)} />
          </DialogContent>
        </Dialog>
      </div>
