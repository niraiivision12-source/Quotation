      ...
      <div className="border-b bg-slate-50 px-5 py-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground">Select products and quantities for this Purchase Order</p>
          </div>
          ...
          <table className="w-full">
            <thead className="bg-slate-100 text-sm">
              <tr>
                ...
                <th className="p-4 text-left w-40">Qty</th>
                <th className="p-4 text-left w-16">Action</th>
              </tr>
            </thead>
